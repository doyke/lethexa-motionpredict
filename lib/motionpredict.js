...
/**
 * Calculates the closest time of approach of two tracks.
 * @method calcCPATime
 ...
 * @return The time of CPA relative to now (0s) or undefined if CPA does not exists. Negative values show a CPA in the past 
 */
